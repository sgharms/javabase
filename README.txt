...
Taking a cue from David Copeland, I decided that instead of writing a
'throwaway' script, I should try to make it a semi-full-fleshed application
using his GLI toolkit. This is the result. A typical invocation would be:
